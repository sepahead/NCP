...
fn sha256(input: &[u8]) -> [u8; 32] {
    ...
    let full_chunks = input.chunks_exact(64);
...
mod tests {
    ...
    #[test]
    fn sha256_hex_should_match_empty_known_answer() {
        assert_eq!(
            sha256_hex(b""),
    ...
    #[test]
    fn sha256_hex_should_match_abc_known_answer() {
        assert_eq!(
            sha256_hex(b"abc"),
    ...
    #[test]
    fn sha256_hex_should_match_two_block_known_answer() {
        assert_eq!(
