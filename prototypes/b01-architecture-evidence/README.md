...
3. Do the finite formulas have satisfiable ordinary-success premises, and do
   guard-removal mutations change their registered results?
4. On this machine and fixed corpus, do separate prototype queues remain
...
[`model_check.py`](model_check.py) exhaustively explores two finite models.
...
| [`assessment_monotonicity.smt2`](smt/assessment_monotonicity.smt2) | authenticated deny removal and assessor tightening are satisfiable; unauthenticated widening is not |
...
A later exact, terminal hardening challenge is bound into the result by response
SHA-256
`356dcd46bcf4e1ad2bb11a878fe5bcaa75a3ae16fc58eb035c674aa08e286deb`.
The later response reported 351 input tokens, 1,934 output tokens, and 957
thinking tokens.
...
and seeded faults for every probe. Rejected advice is documented in
...
- explores the two bounded models and kills seventeen mutations;
- runs nine SMT checks and kills four formula mutations;
