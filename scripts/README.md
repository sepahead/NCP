...
| `validate_evidence_schemas.py [--self-test]` | bounded-read and validate the ledger and decision registry with the hash-locked Draft 2020-12 implementation. It rejects unsupported references, keywords, regexes, formats, vocabularies, and schema drift. Structural validation does not prove external authorship or deployment truth. |
