...
| `generate_b01_review_request.py --commit COMMIT [--self-test] [--check\|--live-check\|--write]` | Generate the exact unfilled human-review roster for the immutable CURRENT B01 packet. Default checking is hermetic. Live checking reobserves canonical and local `main`. The request grants no review or protocol authority. |
