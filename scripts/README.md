...
| `../prototypes/b01-architecture-evidence/adr_example_semantics.py [--self-test]` | compare separate Rust and TypeScript profile results for all 25 source-bound main-ADR JSON fences and 132 bounded mutations. The local and hosted gates pipe this result through its exact nested verifier. This is local non-authorizing evidence only. |
