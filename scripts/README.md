...
| `validate_evidence_schemas.py [--self-test]` | Bounded-read and validate the ledger, decision registry, reviewer kit, and response schema with the hash-locked Draft 2020-12 implementation. The same isolated lock supplies Ruff 0.15.21 for B01 Python checks. Neither tool enters a shipped package surface. Structural validation does not prove external authorship or deployment truth. |
