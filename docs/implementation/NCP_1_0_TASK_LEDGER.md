...
- BulkBlock remains a local or offline helper. Its encoder builds a separate numeric data vector and copies it into the final block, while decode retains duplicate owned column names during uniqueness checks. The 64 MiB block ceiling bounds the local cost but does not satisfy the selected one-buffer observer transport path. B02, B03, N01, N06, and N07 remain open.
...
| `B01` | `IN_PROGRESS` | `COORDINATION_ONLY` | `INDEPENDENT` | `B01-acceptance`, `D01`, `D02`, `D03`, `D04`, `D05`, `D06`, `D07`, `D08`, `D09`, `D10`, `D11`, `D12`, `D13`, `D14`, `D15`, `D16`, `D17`, `D18`, `D19`, `D20`, `D21` | Decide and ratify ADR-001 through ADR-011 | `B04` | NCP | `—` | 50 |
