...
| `B01` | `IN_PROGRESS` | `COORDINATION_ONLY` | `INDEPENDENT` | Decide and ratify ADR-001 through ADR-011 | `B04` | NCP | `—` | 7 |
...
| `C04` | `OPEN` | `IMPLEMENTATION_ONLY` | `LOCAL` | Reconcile and retire the separate Galadriel-producer work branch | `C03` | Crebain and producer worktree | `—` | 0 |
...
| `G03` | `OPEN` | `QUALIFICATION_REQUIRED` | `INDEPENDENT` | Qualify Galadriel's installed observer and deny-only assessor roles | `X02` | Galadriel qualification environment | `—` | 0 |
...
| `C05` | `OPEN` | `QUALIFICATION_REQUIRED` | `INDEPENDENT` | Qualify Crebain body and producer integration separately | `E05`, `H03`, `G03` | Crebain qualification environment | `—` | 0 |
