...
- Wire examples remain draft JSON only. Prior Python/Node replay and preliminary model/resource results bind superseded ADR bytes and remain historical non-passing working evidence. The current review subject binds clean pushed source commit f376f212268b2da4d43975052d692e5f1be50ecb and passed its complete local preflight, but it has no qualifying owner review, independent review, external adjudication, or passing B01 receipt. Canonical formal work, refinement, and every downstream implementation remain open.
